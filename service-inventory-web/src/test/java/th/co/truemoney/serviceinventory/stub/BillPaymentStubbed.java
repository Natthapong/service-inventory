...
public class BillPaymentStubbed {
    ...
    public static Bill createFailMinBillPaymentInfo() {
        ...
        billPaymentInfo.setAmount(new BigDecimal("100"));
        billPaymentInfo.setMinAmount(new BigDecimal("10000"));
        billPaymentInfo.setMaxAmount(new BigDecimal("3000000"));
    ...
    public static Bill createFailMaxBillPaymentInfo() {
        ...
        SourceOfFund sourceOfFundFee = new SourceOfFund();
        sourceOfFundFee.setSourceType("EW");
        sourceOfFundFee.setFeeRate(new BigDecimal("300001"));
        sourceOfFundFee.setFeeRateType("THB");
        sourceOfFundFee.setMinFeeAmount(new BigDecimal("100"));
        sourceOfFundFee.setMaxFeeAmount(new BigDecimal("300000"));
        sourceOfFundFees[0] = sourceOfFundFee;
