...
@WebAppConfiguration
@ContextConfiguration(classes = { ServiceInventoryConfig.class, LocalEnvironmentConfig.class, MemRepositoriesConfig.class, TestJdbcConfig.class, LocalAppleUserConfig.class })
