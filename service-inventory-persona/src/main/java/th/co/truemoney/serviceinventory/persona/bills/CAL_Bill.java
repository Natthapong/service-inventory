...
public class CAL_Bill extends BillTemplate {
    ...
    protected void constructBillResponseTemplate(SIEngineResponse billResponse) {
        ...
        billResponse.addParameterElement("target", "cal");

        billResponse.addParameterElement("service_fee", "500");
        billResponse.addParameterElement("service_fee_type", "THB");
        billResponse.addParameterElement("title_th", "เซ็นเตอร์ ออโต้ลิสซิ่ง");
//        billResponse.addParameterElement("title_en", "");
        ...
        billResponse.addParameterElement("ref2_title_th", "เลขที่สัญญา (10 หลัก)");
...
//        billResponse.addParameterElement("call_center", "");
        billResponse.addParameterElement("logo", "https://secure.truemoney-dev.com/m/tmn_webview/images/logo_bill/cal@2x.png");
