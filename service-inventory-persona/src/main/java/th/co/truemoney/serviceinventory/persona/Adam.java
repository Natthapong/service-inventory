...
import th.co.truemoney.serviceinventory.ewallet.proxy.client.TmnProfileProxyClientImpl;
...
public class Adam implements Persona {
    ...
    public TmnSecurityProxyClient getTmnSecurityClient() {
        return new TmnSecurityProxyClient() {
			...
			@Override
			public StandardBizResponse terminateSession(StandardBizRequest standardBizRequest)	throws EwalletException {
			...
			@Override
			public SignonResponse signon(SignonRequest signOnRequest) throws EwalletException {
	...
	public TmnProfileProxyClient getTmnProfileClient() {
		return new TmnProfileProxyClientImpl() {
		   ...
		   @Override
            public GetBasicProfileResponse getBasicProfile(StandardBizRequest standardBizRequest)
			   ...
			   basicProfileResponse.setEmail("adam@tmn.com");
			   basicProfileResponse.setMobile("0891111111");
			   basicProfileResponse.setFullName("adam");
            ...
            public AddFavoriteResponse addFavorite(AddFavoriteRequest addFavoriteRequest)
                    throws EwalletException {
            	FavoriteContext favoriteContext = createFavoriteContext("1001", "billpay", "trmv", new BigDecimal("13.00"), "20000211101010");
