...
//			
//			ResponseBean<BaseServiceResponseBean> responseBean = new ResponseBean<BaseServiceResponseBean>();
//			responseBean.setData(bodyResponse);
//			
//			return responseBean;
			
			String result = restTemplate.getForObject(configBean.getPathDevUrl("/login"), String.class);
			return result;
